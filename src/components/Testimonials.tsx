  ...
  const testimonials = [
    {
      ...
      country: "🇺🇸",
      quote:
        "The personalized approach transformed my learning experience. My mentor understood exactly what I needed and helped me achieve my goals faster than I ever imagined.",
      rating: 5,
    ...
    },
    {
      ...
      country: "🇮🇳",
      quote:
        "24/7 AI support was a game-changer for me. Whenever I got stuck, help was just a click away. The quality of teaching exceeded all my expectations.",
      rating: 5,
      course: "Data Science",
    },
    {
      ...
      country: "🇪🇸",
      quote:
        "From zero knowledge to landing my dream job in 6 months! The structured curriculum and weekly progress tracking kept me motivated throughout the journey.",
      rating: 5,
    ...
    },
    {
      ...
      country: "🇰🇷",
      quote:
        "The session recordings were incredibly helpful for revision. I could go back and review complex topics anytime. Best investment in my career!",
      rating: 5,
    ...
    },
    {
      ...
      country: "🇬🇧",
      quote:
        "My mentor's expertise and the personalized feedback helped me build confidence in my skills. The one-on-one sessions made all the difference.",
      rating: 5,
      course: "UI/UX Design",
    },
    {
      ...
      country: "🇪🇬",
      quote:
        "The industry-relevant curriculum and real-world projects prepared me perfectly for my new role. Highly recommend this platform to anyone serious about learning.",
      rating: 5,
